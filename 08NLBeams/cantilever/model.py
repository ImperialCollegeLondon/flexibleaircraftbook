...
def generate_fem_file(route, case_name, num_elem, deadforce=600e3, followerforce=0, massless=True):
    length = 5
    num_node_elem=3
...
# Solver options
def generate_solver_file (route, case_name, case_flow, gravity=9.81):
